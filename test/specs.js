(function(){
	...
	vals: for (var vi=0; vi < vals.length; vi++) {
		...
		attrs: for (var ai=0; ai < attrs.length; ai++) {
			...
			// SubtleSlickParse_Specs['should parse attributes: '+ attr +' & val:' + val] = function(){
...
(function(SlickFindingSpecs){
	...
	for (selector in selectors) {
		...
		// SlickFindingSpecs['should find as many "'+selector+'" as qsa' ] = function(){
		// 	value_of( slick(document, selector).length ).should_be( document.querySelectorAll(selector).length );
		// };
