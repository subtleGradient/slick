...
test("element", function() {
	...
	equals( $$("#object1 param").length, 2, "Object/param as context" );

	/* WRONG, results from multiple contexts are not sorted AND filtered, but comma separated items? Sorry, No!
	 */
	isSet( $$("p", document.getElementsByTagName("div")), q("firstp","ap","sndp","en","sap","first"), "Finding elements with a context." );
	isSet( $$("p", "div"), q("firstp","ap","sndp","en","sap","first"), "Finding elements with a context." );
	isSet( $$("p", $$("div")), q("firstp","ap","sndp","en","sap","first"), "Finding elements with a context." );
	...
	isSet( $$("*"), $$("*, *"), "Check for duplicates: *, *" );
	isSet( $$("p"), $$("p, div p"), "Check for duplicates: p, div p" );
...
test("broken", function() {
	...
	function broken(name, selector) {
		try {
			...
			ok(String(e).indexOf("Syntax error") >= 0,
				name + ": " + selector );
		}
	}
...
test("id", function() {
	...
	isSet( $$("div#form", document.body), [], "ID selector within the context of another element" );
...
test("class", function() {
	...
	isSet( $$(".blog", document.getElementsByTagName("p")), q("mark", "simon"), "Finding elements with a context." );
	isSet( $$(".blog", "p"), q("mark", "simon"), "Finding elements with a context." );
	isSet( $$(".blog", $$("p")), q("mark", "simon"), "Finding elements with a context." );
	// isSet( $$(".blog", "p").find(), q("mark", "simon"), "Finding elements with a context." );
	...
	isSet( $$(".e", div), [ div.firstChild ], "Finding a second class." );

	div.lastChild.className = "e";

	isSet( $$(".e", div), [ div.firstChild, div.lastChild ], "Finding a modified class." );
});
...
test("name", function() {
	...
	isSet( $$("#form input[name=action]"), q("text1"), "Name selector within the context of another element" );
	isSet( $$("#form input[name='foo[bar]']"), q("hidden2"), "Name selector for grouped form element within the context of another element" );
...
test("child and adjacent", function() {
	...
	isSet( $$("> :first", document.getElementById("nothiddendiv")), q("nothiddendivchild"), "Verify child context positional selctor" );
	isSet( $$("> :eq(0)", document.getElementById("nothiddendiv")), q("nothiddendivchild"), "Verify child context positional selctor" );
	isSet( $$("> *:first", document.getElementById("nothiddendiv")), q("nothiddendivchild"), "Verify child context positional selctor" );
